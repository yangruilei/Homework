...
public class SharedPrefHelper {
    ...
    public void setTranslationX(float x) {
        sharedPreferences.edit().putFloat("translationX", x).commit();
    }
    public float getTranslationX() {
        return sharedPreferences.getFloat("translationX",0f);
    }

    public void setTranslationY(float y) {
        sharedPreferences.edit().putFloat("translationY", y).commit();
    }
    public float getTranslationY() {
        return sharedPreferences.getFloat("translationY",0f);
    }
}
